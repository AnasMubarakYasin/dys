...
<body class="bg-gray-50 dark:bg-slate-900">
  ...
  <header id="application-header"
    ...
    <nav class="flex basis-full items-center w-full mx-auto px-4 sm:px-6 md:px-8" aria-label="Global">
      ...
      <div class="ml-2 lg:mr-0 lg:hidden">
  ...
  <div id="application-sidebar"
    class="hs-overlay transition-all duration-300 transform fixed top-0 left-0 bottom-0 z-[60] w-64 bg-white border-r border-gray-200 pt-7 pb-10 overflow-y-auto scrollbar-y dark:scrollbar-y dark:bg-gray-800 dark:border-gray-700">
    <div class="px-6">
      <a class="flex-none text-xl font-semibold dark:text-white" href="#" aria-label="Brand">Brand</a>
    </div>
