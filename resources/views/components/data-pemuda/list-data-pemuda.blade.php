                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="p-4 overflow-y-auto">
                                            <form id="import_form" action="{{ route('web.youth.import') }}"
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="overflow-y-auto">
                                            <div class="bg-yellow-50 border border-yellow-200 rounded-t-xl p-4"
                                                role="alert">
                                                <div class="flex">
                                                    ...
                                                    <div class="ml-4">
                                                        <h3 class="text-sm capitalize text-yellow-800 font-semibold">
                                                            hapus semua data
                                                        </h3>
                                            ...
                                            <form id="delete_all_form" action="{{ route('web.youth.delete_all') }}"
                  ...
                  @if ($count && $count > 1)
                    ...
                    @foreach ($elements as $element)
                      @if (is_string($element))
                        ...
                        <div class="overflow-hidden">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700 font-bold">
                                    <tr>
                                        <th scope="col"
                                            class="px-6 py-3 text-left text-xs text-gray-500 uppercase">
                                            Name
                                        </th>
                                        <th scope="col"
                                            class="px-6 py-3 text-left text-xs text-gray-500 uppercase">
                        ...
                        <div class="py-1 px-3 flex justify-between">
                            <form id="fperpage">
