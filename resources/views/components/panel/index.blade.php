{{-- topbar --}}
<header class="flex flex-wrap justify-start z-50 w-full bg-white text-sm py-3 dark:bg-gray-800">
    <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-10 flex items-center justify-between" aria-label="Global">
...
{{-- sidebar --}}
<div id="docs-sidebar"
    class="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 left-0 bottom-0 z-[60] w-64 bg-white border-r border-gray-200 pt-7 pb-10 overflow-y-auto scrollbar-y 2xl:block 2xl:translate-x-0 2xl:right-auto 2xl:bottom-0 dark:scrollbar-y dark:bg-gray-800 dark:border-gray-700">
    <div class="px-6">
        <a class="flex-none text-xl font-semibold dark:text-white" href="javascript:;" aria-label="Brand">Brand</a>
    </div>
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
        <ul class="space-y-1.5">
            <li><a class="flex items-center gap-x-3 py-2 px-2.5 bg-gray-100 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-white/[.05] dark:text-slate-400 dark:hover:text-slate-300"
                    href="#">
            ...
            <li><a class="flex items-center gap-x-3 py-2 px-2.5 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:hover:bg-white/[.05] dark:text-slate-400 dark:hover:text-slate-300"
                    href="#">
                    <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        fill="currentColor" viewBox="0 0 16 16">
                        <path
